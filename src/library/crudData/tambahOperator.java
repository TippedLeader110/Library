 ...
 * @author My Computer
 */
public class tambahOperator extends javax.swing.JFrame {

    /**
     * Creates new form tambahOperator
     */
    public tambahOperator() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tambah Operator Baru");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambahOperator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tambahOperator().setVisible(true);
            }
        });
    }
